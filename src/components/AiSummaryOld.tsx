...
const PRIMARY_GRADIENT = "linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%)";
            ...
            >
              <Divider orientation="left" plain style={{
                ...
                <Space>
                  ...
                  <Text strong style={{ fontSize: 16, color: "#234" }}>Performance Summary</Text>
                </Space>
              </Divider>
              <Paragraph style={{
                fontSize: 17,
            ...
            >
              <Divider orientation="left" plain style={{ fontSize: 17, fontWeight: 800, color: "#b71c1c" }}>
                <Space>
                  ...
                  <Text strong style={{ fontSize: 15, color: "#b71c1c" }}>Key Areas for Improvement</Text>
                </Space>
              </Divider>
            ...
            >
              <Divider orientation="left" plain style={{ fontSize: 16, fontWeight: 800, color: "#40557f" }}>
                <Space>
                  ...
                  <Text strong style={{ fontSize: 15, color: "#2c3f60" }}>Recommended Problems</Text>
                </Space>
              </Divider>
